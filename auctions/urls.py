...
urlpatterns = [
    ...
    path("removelisting/<int:product_id>", views.removelisting, name="removelisting"),
    ...
    path("removecomment/<int:product_id>/<int:comment_id>", views.removecomment, name="removecomment"),
